package com.SENA.EasyCarRent.FleetManagement.Controller;
...
import com.SENA.EasyCarRent.FleetManagement.DTO.ApiResponseDto;
...
public abstract class ABaseControllerFleetManagement <T extends ABaseEntityFleetManagement, DReq, DRes, S extends IBaseServiceFleetManagement<T, DReq, DRes>> {
    protected S service;
    protected String entityName;

    protected ABaseControllerFleetManagement(S service, String entityName) {

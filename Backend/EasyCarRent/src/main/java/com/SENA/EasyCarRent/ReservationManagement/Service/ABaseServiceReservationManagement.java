...
abstract public class ABaseServiceReservationManagement<T extends ABaseEntityReservationManagement, DReq, DRes> implements IBaseServiceReservationManagement<T, DReq, DRes> {
     ...
     */
    protected abstract IBaseRepositoryReservationManagement<T, String> getRepository();

package com.SENA.EasyCarRent.FleetManagement.Service;

import com.SENA.EasyCarRent.FleetManagement.Entity.ABaseEntityFleetManagement;
import com.SENA.EasyCarRent.FleetManagement.IRepository.IBaseRepositoryFleetManagement;
import com.SENA.EasyCarRent.FleetManagement.IService.IBaseServiceFleetManagement;
...
abstract public class ABaseServiceFleetManagement<T extends ABaseEntityFleetManagement, DReq, DRes> implements IBaseServiceFleetManagement<T, DReq, DRes> {
     ...
     */
    protected abstract IBaseRepositoryFleetManagement<T, String> getRepository();

...
import com.SENA.EasyCarRent.ReservationManagement.IService.IBaseServiceReservationManagement;
import com.SENA.EasyCarRent.ReservationManagement.DTO.ApiResponseDto;
...
public abstract class ABaseControllerReservationManagement <T extends ABaseEntityReservationManagement, DReq, DRes, S extends IBaseServiceReservationManagement<T, DReq, DRes>> {
    protected S service;
    protected String entityName;

    protected ABaseControllerReservationManagement(S service, String entityName) {

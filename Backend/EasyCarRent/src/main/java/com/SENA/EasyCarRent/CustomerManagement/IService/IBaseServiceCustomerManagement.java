package com.SENA.EasyCarRent.CustomerManagement.IService;
...
public interface IBaseServiceCustomerManagement<T extends ABaseEntityCustomerManagement, DReq, DRes> {
    /**
